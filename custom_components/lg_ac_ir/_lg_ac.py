# Vendored from home-assistant-libs/infrared-protocols (MIT License, Copyright (c)
# 2026 Home Assistant Team):
#   https://github.com/home-assistant-libs/infrared-protocols
#   infrared_protocols/commands/lg_ac.py
# Bundled locally so this integration works on Home Assistant versions whose shipped
# infrared-protocols predates the LG AC encoder (e.g. HA 2026.7.x pins 6.3.0). The only
# change from upstream is repointing the `Command` import to the installed package; the
# encoder logic is unchanged.
